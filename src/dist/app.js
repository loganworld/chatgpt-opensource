...
var main = function () { return __awaiter(void 0, void 0, void 0, function () {
    var gpt4all, prompt, response, prompt2, response2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                gpt4all = new gpt4all_1.GPT4All();
            ...
            case 3:
                ...
                prompt2 = 'Explain to a five year old why AI is nothing to be afraid of.';
                return [4 /*yield*/, gpt4all.prompt(prompt2)];
            case 4:
                response2 = _a.sent();
