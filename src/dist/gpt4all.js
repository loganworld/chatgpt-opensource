            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        this.bot = child_process_1.spawn(spawnArgs[0], spawnArgs.slice(1), { stdio: ['pipe', 'pipe', 'ignore'] });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, util_1.promisify(child_process_1.exec)('uname -m')];
                    case 1:
                    ...
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, fs_1["default"].chmod(this.executablePath, 493, function (err) {
                                if (err) {
                                    throw err;
                                }
                            })];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        dir = new URL("file://" + os_1["default"].homedir() + "/.nomic/");
                        return [4 /*yield*/, fs_1["default"].mkdir(dir, { recursive: true }, function (err) {
                                if (err) {
                                    throw err;
                                }
                            })];
                    case 2:
                        _b.sent();
                        writer = fs_1["default"].createWriteStream(destination);
