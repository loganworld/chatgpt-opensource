...
Intel Mac/OSX: cd chat;./gpt4all-lora-quantized-OSX-intel
    */
        ...
        this.executablePath = path.normalize(`${__dirname}/../.nomic/gpt4all-lora-quantized-win64.exe`)
        this.modelPath = path.normalize(`${__dirname}/../.nomic/${model}.bin`)
